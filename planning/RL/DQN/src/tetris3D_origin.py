...
class Tetris3D:
    ...
    def reset(self):
        ...
        self.last_item = {'item': [0, 0, 0], 'position': {'x': 0, 'y': 0, 'z': 0}}
    ...
    def get_next_states(self):
        ...
        for i in self.action_space:
            ...
            states[(x, r)] = self.get_board_state(bin_matrix)   # i: 회전 방향
    ...
    def render(self, several_axis_view=False, plot_name=None, data_dir='render'):
    ...
    def save_gif(self, output_directory=None, plot_name='tetris3d', data_dir='render'):
    ...
    # def plot_piece(self, bin_matrix, save_path=None):
    #     fig = plt.figure()
    ...
    #         plt.show()
    #     plt.close()
    def plot_piece(self, bin_matrix = None, plot_name= None, several_axis_view=False, data_dir = 'render'):
        '''
        dynamic_display가 True이면 여러 방향
        
        '''
        if bin_matrix is None:
            bin_matrix = self.get_current_board_state()
